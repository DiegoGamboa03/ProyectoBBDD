...
namespace Proyecto_base_de_datos.Class
{
    public class Students
    {
        ...
        public Students(string id, string name, string personalEmail, string ucabMail, string phoneNumber, string bonusAttribute)
        {
            this.Id = id;
            this.Name = name;
        ...
        public string BonusAttribute { get => bonusAttribute; set => bonusAttribute = value; }
    }
}
